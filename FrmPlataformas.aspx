...
<br />
    ...
    <div class="well">
        <table>
            <tr>
                <td><asp:Label ID="Label1" runat="server" Text="Plataforma"></asp:Label></td>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            ...
                            <Columns>
                                <asp:BoundField DataField="idPlataforma" HeaderText="Id" HtmlEncode="false">
                                    <ItemStyle  Width="100px" />
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Top" Width="100px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="strNombre" HeaderText="Plataformas" HtmlEncode="false">
