                ...
                <table>
                    <tr valign="middle">
                        <td class="auto-style1">
                            <asp:Label ID="Label1" runat="server" Text="Plataforma"></asp:Label></td>
                        <td class="auto-style1">
                            <asp:TextBox ID="txtPlataforma" runat="server" CssClass="form-control" Height="28px" Width="180px" CausesValidation="True"></asp:TextBox>
                            <td class="auto-style1">
                        ...
                        <asp:GridView ID="GridView1"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Id" Visible="false">
                                    <EditItemTemplate>
                                        <asp:Label ID="lblEditIdPlataforma" runat="server" Text='<%# Bind("idPlataforma") %>' Visible="false"></asp:Label>
