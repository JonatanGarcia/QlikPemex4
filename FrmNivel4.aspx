...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="well">
        <table>
            <tr>
                ...
                <td><asp:TextBox ID="TxtNivel4" runat="server" CssClass="form-control" Height="28px" Width="180px"></asp:TextBox></td>
            </tr>
            <tr>
                <td>
                    <br />
                    <asp:Label ID="Label2" runat="server" Text="Nivel 3"></asp:Label></td>
                <td>
                    <br />
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Lista Nivel 4</h3>
        </div>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Id" Visible="false">
                                    <EditItemTemplate>
                                        <asp:Label ID="TextBox1" runat="server" Text='<%# Bind("idNPTN4") %>'></asp:Label>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("idNPTN4") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Nivel 4">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("nivel4") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("nivel4") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Nivel 3">
                                    <EditItemTemplate>
                                        <asp:Label ID="lblIdN3" runat="server" Text='<%# Bind("idNPTN3") %>' Visible="false"></asp:Label>
                                        <asp:DropDownList 
                                            ID="ddlEditN3" 
                                            runat="server">
                                        </asp:DropDownList> 
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("nivel3") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle VerticalAlign="Top" Width="200px" />
                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Nivel 2">
                                    <EditItemTemplate>
                                        <asp:Label ID="TextBox4" runat="server" Text='<%# Bind("nivel2") %>'></asp:Label>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("nivel2") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle VerticalAlign="Top" Width="200px" />
                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Nivel 1">
                                    <EditItemTemplate>
                                        <asp:Label ID="TextBox5" runat="server" Text='<%# Bind("nivel1") %>'></asp:Label>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("nivel1") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle VerticalAlign="Top" Width="200px" />
                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                </asp:TemplateField>
                                <asp:TemplateField ShowHeader="False">
                                    <ItemTemplate>
                                        <asp:LinkButton 
                                            ID="lnkRemove" 
                                            runat="server" 
                                            CommandArgument='<%# Eval("idNPTN4")%>'                                            
                                            Text="Eliminar"
                                            OnClick="GridView1_RowDeleting"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
