...
Partial Class _Default
    ...
    Protected Sub GridView1_RowDeleting(sender As Object, e As EventArgs) Handles GridView1.RowDeleting
        ...
        Catch ex As Exception
            'validador bootstrap
            lblGridMsg.Text = "La Plataforma que intenta eliminar ya contiene información relacionada."
    ...
    Protected Sub GridView1_RowUpdating(sender As Object, e As GridViewUpdateEventArgs) Handles GridView1.RowUpdating
        Dim idPlataforma As Integer = DirectCast(GridView1.Rows(e.RowIndex).FindControl("lblEditIdPlataforma"), Label).Text
