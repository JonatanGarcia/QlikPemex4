        ...
        <ContentTemplate>            
            ...
            <div class="well">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="Equipo"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtEquipo" runat="server" CssClass="form-control" Height="28px" Width="180px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>
                            <br />
                        ...
                        <td>
                            <br />
                            <asp:DropDownList ID="ddlCia" runat="server" CssClass="form-control" Height="28px" Width="180px"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Id" Visible="false">
                                    <EditItemTemplate>
                                        <asp:label ID="TextBox3" runat="server" Text='<%# Bind("idEquipo")%>'></asp:label>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("idEquipo") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Equipo">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Equipo") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Compañia">
                                    <EditItemTemplate>
                                        <asp:Label ID="lblIdCia" Visible="false" runat="server" Text='<%# Bind("idCatCompania")%>'></asp:Label>
                                        <asp:DropDownList
                                            ID="ddlEditCia"
                                            runat="server">
                                        </asp:DropDownList>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("Cia") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle VerticalAlign="Top" Width="200px" />
                                    <ItemStyle HorizontalAlign="Center" Width="200px" />
                                </asp:TemplateField>
