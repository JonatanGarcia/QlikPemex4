...
Partial Class _Default
    ...
    Sub llenar()
        ...
        CmdN1.DataSource = (From N1 In ds.Tables(0) _
                            Select N1.Field(Of String)("nivel2")).Distinct ',
    ...
    End Function
    Sub inicializar()
        If Me.Cache("nivel3") Is Nothing Then
            Me.Cache.Insert("nivel3", Generic("SELECT " & _
                " N3.idNPTN3,  N3.strNombre AS nivel3, N2.idNPTN2, N2.strNombre as nivel2 , N1.idNPTN1, N1.strNombre as nivel1 " & _
                " FROM CAT_NPTS_N3 N3 " & _
