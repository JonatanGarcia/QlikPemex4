<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="FrmEtapas.aspx.vb" Inherits="_Default" %>
        ...
        <ContentTemplate>            
                ...
                <table>
                    <tr valign="middle">
                        <td class="auto-style1">
                            <asp:Label ID="Label1" runat="server" Text="Etapa"></asp:Label></td>
                        <td class="auto-style1">
                            <asp:TextBox ID="txtEtapa" runat="server" CssClass="form-control" Height="28px" Width="180px" CausesValidation="True"></asp:TextBox>
                            <td class="auto-style1">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Lista de Etapas</h3>
                </div>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Id" Visible ="False">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("idEtapa") %>' visible="false"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("idEtapa") %>'></asp:Label>
                                    </ItemTemplate>
