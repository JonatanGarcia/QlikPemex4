...
Partial Class _Default
    ...
    Sub llenar()
        ...
        CmdN1.DataSource = (From N1 In ds.Tables(0) _
                            Select N1.Field(Of String)("compania")).Distinct ',
    ...
    End Function
    Sub inicializar()
        If Me.Cache("equipo") Is Nothing Then
            Me.Cache.Insert("equipo", Generic("SELECT " & _
                " E.idEquipo as idE, E.strNombre as equ, CC.strNombre as compania FROM CAT_EQUIPO E " & _
                " INNER JOIN CAT_COMPANIA CC ON CC.idCatCompania=E.idCatCompania"))
        End If
    End Sub
